local lib = import 'packer.jsonnet';
{
  ...
  provisioners:
    ...
    lib.prov_aptinst(["./amd64/consul.deb ./amd64/nomad.deb ./amd64/node_exporter.deb ./amd64/prometheus.deb ./amd64/process-exporter.deb ./all/process-exporter-config.deb"])
}
